...
Процедура ВыполнитьСозданиеАктов(Команда)    
	...
	ДлительнаяОперация = ЗапуститьДлительнуюОперацию(ПараметрыЗапуска, УникальныйИдентификатор);  
...
Функция  ЗапуститьДлительнуюОперацию(ПараметрыЗапуска, УникальныйИдентификатор)
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(УникальныйИдентификатор,"Обработка.ВКМ_МассовоеСозданиеАктов.МодульОбъекта.МассвоеСоздание",ПараметрыЗапуска);
	//ОбработкаОбъект = РеквизитФормыВЗначение("Объект");
	//Обработка = ОбработкаОбъект.МассвоеСоздание(Объект.Период); 
